<template>
  ...
  <label for="page-1"  class="book__page book__page--1">
    <img src="https://m.media-amazon.com/images/I/51fTZdEBXVL._SX411_BO1,204,203,200_.jpg" alt="">
  </label>
  
  <label for="page-2" class="book__page book__page--4">
    <div class="page__content">
      <h1 class="page__content-title">Book Description</h1>
  ...
  <label class="book__page book__page--2">
    <div class="book__page-front">
      <div class="page__content">
        <h1 class="page__content-book-title">TITLE api</h1>
        <h2 class="page__content-author">Author api</h2>
        
      </div>
    </div>
    <div class="book__page-back">
      <div class="page__content">
        <h1 class="page__content-title">SHARE EMAIL ICON???</h1>
